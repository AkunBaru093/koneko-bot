...
//
const BotName = 'Koneko-Bot'; // Nama Bot Whatsapp
const instagramlu = '~~~'; // Nama Instagramlu cok
const whatsapplu = '0858-2177-9769'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/LpWR9Ks26ZxAc7MoVUVFnq'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/LpWR9Ks26ZxAc7MoVUVFnq'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
